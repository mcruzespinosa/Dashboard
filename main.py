...
import io
import os
from database import verify_user, add_user, obtener_proyectos,load_db_path, add_incident, get_incidents, create_tables, add_exam
from datetime import datetime
import numpy as np
